...
//#define FILE_NODE "COL.node"
//#define FILE_EDGE "COL.edge"
#define FILE_NODE "NY.node"
#define FILE_EDGE "NY.edge"
#define FILE_MORTON "NY.morton"
...
#define FILE_OBJECT "COL.object.4357.99"
#define FILE_QUERY "COL.query"
typedef struct{
	double x,y;
	vector<int> adjnodes;
...
void init_input(){
	...
	while( fscanf(fin, "%d %lf %lf", &nid, &x, &y ) == 3 ){
		...
		//std::cout << "x* WEI"<< x * WEIGHT_INFLATE_FACTOR<< endl;
		// get map tag
        nmap[x][y] = Nodes.size();
	}
	fclose(fin);
